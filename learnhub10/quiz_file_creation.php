...
<?php
	...
	$file_string=array("TotalQuestion"=>$no_of_questions,"TotalMarks"=>$_POST['totalMarks']);
	...
	$query="INSERT INTO event(eventid,courseid,fileid,resp_eventid,event_date,due_date,event_eval,event_feedback,event_type) VALUES ('Quiz_c".$id."','$courseid','$id',NULL,CURDATE(),CURDATE(),NULL,NULL,'Quiz_c')";
